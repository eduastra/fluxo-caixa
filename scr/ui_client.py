...
class Application:
    ...
    def init_ui(self):
        self.buttons = [
            tk.Button(
                self.master,
                text="Venda",
                command=lambda: print("Botão Venda clicado"),
                font=("Arial", 22),
            ),
            tk.Button(
                self.master,
                text="Entrada",
                command=lambda: print("Botão Entrada clicado"),
                font=("Arial", 22),
            ),
            tk.Button(
                self.master,
                text="Estoque",
                command=lambda: print("Botão Estoque clicado"),
                font=("Arial", 22),
            ),
            tk.Button(
                self.master,
                text="Relatório",
                command=lambda: print("Botão Relatório clicado"),
                font=("Arial", 22),
            ),
            tk.Button(
                self.master,
                text="Logout",
                command=lambda: print("Botão Logout clicado"),
                font=("Arial", 22),
            ),
        ]
    ...
    def display_home(self):
        ...
        self.clock_label.grid(row=8, column=4, pady=200)
